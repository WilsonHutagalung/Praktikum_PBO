...
public class Admin extends Akun implements AdminInterface {
    ...
    public boolean MenuUtama() throws IOException {
        boolean lanjut = true;
        while (lanjut) {
            clear();
    ...
    @Override
    public void Menu_Tambah() throws IOException{
        clear();
    ...
    @Override
    public void Menu_lihat() throws IOException {
        clear();
    ...
    @Override
    public void Menu_Update() throws IOException {
        clear();
        System.out.println("=".repeat(41));
    ...
    @Override
    public void Menu_Hapus() throws IOException {
        clear();
