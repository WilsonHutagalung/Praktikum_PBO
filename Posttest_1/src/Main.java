...
public class Main {
    ...
    static void Login() throws IOException {
        ...
        for (Akun akun : DataAkun) {
            if (akun.Username.equals(user) && akun.Password.equals(pass)) {
                clear();
                System.out.println("===================");
    ...
    static void MenuUtama() throws IOException {
        boolean lanjut = true;
        while (lanjut) {
            clear();
    ...
    static void UpdateData() throws IOException {
        ...
        for (DestinasiWisata Destinasi : DataDestinasi) {
            if (Destinasi.Nama_Destinasi.equalsIgnoreCase(UpdateData)) {
                ditemukan = true;
                ...
                Destinasi.Nama_Destinasi = Nama;
                Destinasi.Lokasi = Lokasi;
                Destinasi.Deskripsi = Deskripsi;
                Destinasi.Tahun_DiTemukan = Tahun;
                Destinasi.Jumlah_Kunjungan = Kunjungan;
    ...
    static void HapusData() throws IOException {
       clear();
        ...
        boolean ditemukan = false;
        for (DestinasiWisata Destinasi : DataDestinasi) {
            if (Destinasi.Nama_Destinasi.equalsIgnoreCase(HapusData)) {
                ditemukan = true;
